...
/**
 * Resources needed to load icons and language files into OTR plugin
 * 
 * @author
 */
...
public class NavigateResources {

    private static PropertyResourceBundle prb;

    static ClassLoader cl = NavigateResources.class.getClassLoader();

    static {
        prb = (PropertyResourceBundle) ResourceBundle.getBundle("i18n/navigate_i18n");
    }
    ...
    public static ImageIcon getIcon(String fileName) {
        final ClassLoader cl = NavigateResources.class.getClassLoader();
